...
**Answer**: 0, all 77 Values are NAs
...
**Answer**: 8 points failed QCP_2. Looks like it often happens before midday, but there is no clear pattern to the data.
...
**Answer**:  Reasons for failure were sudden temperature changes (QCP_2, 8 points) and constant temperature over at least one hour (QCP_3, 60 points). All temperature readings were in the measurement-interval (QCP_1). The sensor never experienced more than 5166.7 lux (QCP_4) which was not enough for not passing the checkpoint.
